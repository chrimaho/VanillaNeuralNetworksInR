...
# Download Data
# NOTE: The first time you run this function, it may take a while to download.
#       All other times you run it, Tensorflow will load from Cache before re-downloading.
...
plt_ConfusionMatrix <- function(confusion_matrix) {
    ...
    #' @param confusion_matrix `caret::confusionMatrix()`. The confusion matrix, as produced by `caret::confusionMatrix()`.
